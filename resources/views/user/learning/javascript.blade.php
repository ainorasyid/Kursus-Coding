                        ...
                        <div class="col-md-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <a href="{{ route('user.learning.javascript.pengenalan') }}"
                        ...
                        <div class="col-md-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <a href="{{ route('user.learning.javascript.variable') }}"
                                        class="btn btn-primary w-100">
                                        Pelajari Materi
                                    </a>
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <a href="{{ route('user.learning.javascript.function') }}"
                                        class="btn btn-primary w-100">
                                        Pelajari Materi
                                    </a>
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <a href="{{ route('user.learning.javascript.dom') }}"
                                        class="btn btn-primary w-100">
                                        Pelajari Materi
                                    </a>
                                </div>
