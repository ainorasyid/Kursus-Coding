    ...
    <div class="page-wrapper overflow-hidden">
        ...
        <section class="banner-section position-relative d-flex align-items-end min-vh-100">
            <video class="position-absolute top-0 start-0 w-100 h-100 object-fit-cover" autoplay muted loop playsinline>
                <source src="{{ asset('assets/landingPage/images/backgrounds/banner.mp4')}}" type="video/mp4" />
            </video>
            <div class="container">
                    ...
                    <div class="row align-items-center">
                        <div class="col-xl-4">
                            <div class="d-flex align-items-center gap-4" data-aos="fade-up" data-aos-delay="100"
                                ...
                                <p class="mb-0 text-white fs-5 text-opacity-70">Kami menyediakan <span
                                        class="text-primary">pembelajaran pemrograman </span> meningkatkan skill digital
                                    dan membuka peluang masa depan. </p>
                            </div>
                        </div>
                    </div>
                    <div class="d-flex align-items-end gap-3" data-aos="fade-up" data-aos-delay="200"
                        data-aos-duration="1000">
                        <h1 class="mb-0 fs-16 text-white lh-1">Codenova</h1>
                            ...
                            <form class="d-flex flex-column gap-7" data-aos="fade-up" data-aos-delay="200"
                                ...
                                <div>
                                    <textarea class="form-control border-bottom border-dark"
                                        id="exampleFormControlTextarea1" placeholder="Tell us about your project"
                                        rows="3"></textarea>
                                </div>
