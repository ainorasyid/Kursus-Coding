...
<head>
    ...
    <title>Mentor - Edit Materi</title>
                                    ...
                                    <div class="form-body">
                                        <div class="row">
                                                    ...
                                                    <select class="form-select"
                                                        ...
                                                        @foreach ($kursus as $item)
                                                            <option value="{{ $item->id }}"
                                                                {{ $materi->kursus_id == $item->id ? 'selected' : '' }}>
                                                                {{ $item->judul }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <div class="col-sm-12 mt-4 d-flex justify-content-between">
                                                <a href="{{ route('admin.manajemen-kursus.materi') }}"
                                                    class="btn btn-primary me-1 mb-1 d-flex align-items-center gap-2">
